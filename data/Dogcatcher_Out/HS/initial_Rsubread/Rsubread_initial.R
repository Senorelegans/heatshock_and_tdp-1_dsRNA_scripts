...
file="HEATSHOCK_LFC_FLIPPED_DOG_2ndtime/initial_Rsubread/Rsubread_sense.txt",
...
file="HEATSHOCK_LFC_FLIPPED_DOG_2ndtime/initial_Rsubread/Rsubread_antisense.txt",
quote=FALSE,sep="\t",row.names=FALSE)
