...
# f1 = "HS_combined_LONGEST_RUN_ON.csv"
# f2 = "HS_combined_antisense_LONGEST_RUN_ON.csv"
#
# f3 = "OK_combined_LONGEST_RUN_ON.csv"
# f4 = "OK_combined_antisense_LONGEST_RUN_ON.csv"


f1 = "../unique_DOG/HS_combined_DOG_noOperon_unique_cleaned.csv"
f2 = "../unique_DOG/HS_combined_ADOG_noOperon_unique_cleaned.csv"
f3 = "../unique_DOG/OK_combined_DOG_noOperon_unique_cleaned.csv"
f4 = "../unique_DOG/OK_combined_ADOG_noOperon_unique_cleaned.csv"
...
df_HS_sense_above_2_lfc.to_csv("df_HS_sense_above_padj.05.csv",sep="\t",index=None)
df_HS_sense_below_2_lfc.to_csv("df_HS_sense_below_padj.05.csv",sep="\t",index=None)
df_OK_sense_above_2_lfc.to_csv("df_OK_sense_above_padj.05.csv",sep="\t",index=None)
df_OK_sense_below_2_lfc.to_csv("df_OK_sense_below_padj.05.csv",sep="\t",index=None)
df_HS_anti_sense_above_2_lfc.to_csv("df_HS_anti_sense_above_padj.05.csv",sep="\t",index=None)
df_HS_anti_sense_below_2_lfc.to_csv("df_HS_anti_sense_below_padj.05.csv",sep="\t",index=None)
df_OK_anti_sense_above_2_lfc.to_csv("df_OK_anti_sense_above_padj.05.csv",sep="\t",index=None)
df_OK_anti_sense_below_2_lfc.to_csv("df_OK_anti_sense_below_padj.05.csv",sep="\t",index=None)
...
# plt.title("Heatshock and tdp-1(ok803) \n Sense J2 Enrichment compared to WT \n  log2FoldChange > 0 \n (Padj) < 0.05", fontsize=20)
plt.savefig('Heatshock and tdp-1(ok803) Sense J2 Enrichment compared to WT.png',bbox_inches='tight')
...
c[0].set_ls('dashed')  # Line style
c[0].set_lw(2.0)       # Line width
# plt.title("Antisense Heatshock and tdp-1(ok803) \n Sense J2 Enrichment compared to WT \n  log2FoldChange > 0 \n (Padj) < 0.05", fontsize=20)
plt.savefig('Antisense Heatshock and tdp-1(ok803) Sense J2 Enrichment compared to WT.png',bbox_inches='tight')
#savefig('foo.png', bbox_inches='tight')
#plt.show()
