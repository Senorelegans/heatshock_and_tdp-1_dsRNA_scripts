...
IN=HEATSHOCK_LFC_FLIPPED_DOG_2ndtime     #This is the output folder from part II
COMPARISON_PATH=${IN}/N2_vs_HS_2ndtime

BAMPATH=BAMS
BEDPATH=BEDS/BEDS_HS
CPUS=4
...
N2HS_INP_split_plu.BedGraph \
N2HS_J2A_split_plu.BedGraph \
N2HS_J2B_split_plu.BedGraph \
...
N2HS_INP_split_min.BedGraph \
N2HS_J2A_split_min.BedGraph \
N2HS_J2B_split_min.BedGraph \
...
#${STAROUT}/N2HS_INP_TLog.final_rRNA.out \
...
#${STAROUT}/N2HS_J2A_TLog.final_rRNA.out \
#${STAROUT}/N2HS_J2B_TLog.final_rRNA.out \
